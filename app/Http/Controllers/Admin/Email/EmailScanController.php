...
use App\Repositories\Facebook\EmailScan\EmailScanRepositoryInterface;
...
class EmailScanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.email_scan', compact('user'));
    }
    ...
    public function showEmailScan($id)
    {
        ...
        if (!$emailScan) {
            return response()->json(['error' => 'Email Scan not found'], 404);
        }
