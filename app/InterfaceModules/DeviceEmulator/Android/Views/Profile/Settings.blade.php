            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row merged20" id="page-contents">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="security" role="tabpanel">
                                                <div class="set-title">
                                                    ...
                                                    <span>Trường hợp bạn muốn thay đổi mật khẩu, vui lòng nhập đầy đủ thông tin bên dưới.</span>
                                                </div>
                                                <div class="seting-box">
                                                    <form  action="{{ route('profile.changePassword', ['uid' => $uid]) }}" method="post">
                                                        @csrf
                                                        <div class="form-group">
                                                            <label for="current_password">Mật khẩu hiện tại</label>
                                                            <input type="text" class="form-control" id="current_password" name="current_password" value="{{ $data['account']->password }}" required>
                                                        </div>
                                                        <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            @include('user.pages.Content.Sidebar_static_right.aside')
                        </div>
