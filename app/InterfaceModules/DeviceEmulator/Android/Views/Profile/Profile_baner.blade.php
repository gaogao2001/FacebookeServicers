        ...
        <div class="row">
            <div class="col-lg-2 col-md-3">
                <div class="profile-author" style="margin-top: -130px !important;">
                    <div class="profile-author-thumb">
                        @if(empty($data['account']->avatar))
                            <img alt="author" src="/images/default-avatar.jpg">
                        @else
                            <img alt="author" src="{{ $data['account']->avatar }}">
                        @endif
                        <div class="edit-dp">
                            <label class="fileContainer">
                                <i class="fa fa-camera"></i>
                    ...
                    <a class="h4 author-name" href="about.html">
                        {{ !empty($data['account']->name) ? $data['account']->name : (!empty($data['account']->fullname) ? $data['account']->fullname : 'Tên không có sẵn') }}
                    </a>
                </div>
            </div>
            <div class="col-lg-10 col-md-9">
                <ul class="profile-menu">
                    ...
                    <li>
                        <a class="{{ request()->routeIs('profile.showVideo') ? 'active' : '' }}" href="{{ route('profile.showVideo', ['uid' => $uid]) }}">Videos</a>
                    </li>
                    <li>
                        <div class="more">
