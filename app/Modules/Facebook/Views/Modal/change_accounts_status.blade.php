<style>
    ...
    /* Header của modal */
    #changeStatusModal .modal-header {
    ...
    /* Form input */
    #changeStatusModal .form-control {
        background-color: #ffffff;
        color: #333333;
    ...
    #changeStatusModal .form-control:focus {
        border-color: #007bff;
    ...
    #changeStatusModal .list-group-item {
        background-color: #f8f9fa;
        color: #333333;
    ...
    /* Footer của modal */
    #changeStatusModal .modal-footer {
    ...
    #changeStatusModal .btn-secondary {
        background-color: #6c757d;
        color: #ffffff;
        border: none;
    }

    #changeStatusModal .btn-secondary:hover {
        background-color: #5a6268;
    }

    #changeStatusModal .btn-primary {
        ...
        <form id="changeStatusForm">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="changeStatusModalLabel">Thay Đổi Trạng Thái Tài Khoản</h5>
