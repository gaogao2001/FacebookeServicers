			...
			<div class="modal-content wrapper">
				<div class="card btn btn-success btn-fw" style="background-color: #28a745; border-color: #28a745;">
					<div class="card-header">
						<h3 class="modal-title ">Xuất tài khoản quảng cáo</h3>
					</div>
				</div>
				<form action="#" method="post">
						...
						<div class="row" id="hqitFormImport">
							<div class="col-sm-12">
								...
								<div class="form-group">
									<textarea class="form-control" id="account_list" name="account_list" rows="7" style="resize: vertical; overflow-y: auto;" placeholder="Vui lòng nhập dữ liệu nick vào đây...."></textarea>
								</div>
								<div class="form-group">
					...
					<div class="modal-footer justify-content-between">
						...
						<button class="btn btn-primary BtnExportAccount">Xuất file</button>
					</div>
				</form>
			</div>
		</div>
