                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <ul class="job-progres">
                                        <li><span class="main-color">97%</span> Success Jobs</li>
                                        <li><span class="color-blue">10</span> Jobs in Progress</li>
                                        <li><span class="color-valvet">102</span> Jobs Completed</li>
                                    </ul>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
